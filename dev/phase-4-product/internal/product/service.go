...
// Service holds the product business rules (architecture §17). It depends only
...
func (s *Service) List(ctx context.Context, filter ProductFilter) (*Page[ProductOutput], error) {
	if filter.Page == 0 {
		filter.Page = 1
	}

...
type ProductRepository interface {
	...
	List(ctx context.Context, filter ProductFilter) (*Page[Product], error)
}
...
func (r *InMemoryRepository) List(_ context.Context, filter ProductFilter) (*Page[Product], error) {
	r.mu.RLock()

...
// CreateOrderInput is the decoded body of POST /api/orders (architecture §12).
...
// OrderOutput is the public view returned by the API (architecture §12).
...
// OrderFilter carries list query parameters (architecture §13).

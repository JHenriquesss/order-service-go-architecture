...
// BR-ORD-005 + architecture §12 example totals.
...
// BR-ORD-006 + §20: publish after commit.
...
// commit ok + publish fail → 500, logged, order NOT lost.
...
func (r *listEnrichBrokenRepo) List(ctx context.Context, filter OrderFilter) (*Page[Order], error) {
	return &Page[Order]{
...
func (b *brokenRepo) List(ctx context.Context, filter OrderFilter) (*Page[Order], error) {

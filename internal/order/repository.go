...
// OrderRepository is the persistence port (architecture Ã‚Â§18). CreateWithItems
// is the unit-of-work boundary: order and items are persisted atomically.
...
type InMemoryRepository struct {
	...
	// CommitCount records how many atomic create commits completed.
	CommitCount int
	// OnCreate is an optional hook for tests to observe persistence order.
